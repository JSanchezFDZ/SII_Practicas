...
INSERT INTO APP.SOCIOS (ID, FECHAALTA, FECHABAJA, APELLIDO, CERTIFICADO, CODPOSTAL, CORREO, DIRECCION, ESTADO, NOMBRE, OBSERVACIONES, POBLACION, PROVINCIA, SECTOR, TELEFONO, USUARIO_USUARIO) VALUES (101, '2019-05-30 13:30:19.142', '2020-05-30 13:30:27.21', 'Martinez', 'Certificado A', 29010, 'juanM@gmail.com', 'c/ alameda nº 56', 'Padrino', 'Juan', 'Es voluntario', 'Málaga', 'Málaga', 'Empresario', '697282549', '101')

INSERT INTO APP.USUARIO (USUARIO, APELLIDOS, EMAIL, PASS, ROL, SOCIO_ID) VALUES ('101', 'Martinez', 'juanM@gmail.com', '123', 'Apadrinador', '101')
